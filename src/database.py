...
def save_property_to_db(session, estate_data):
    ...
    if existing_property:
        ...
        property_obj = Property(
            ...
            garage_quantity=estate_data.get('cocheras') if estate_data.get('cocheras') else 0,
            property_type=estate_data.get('property_type', '')[:255],
            url=estate_data.get('url', '')[:255],
            title=estate_data.get('title', '')[:255],
            enviroments=estate_data.get('ambientes'),
            bedrooms=estate_data.get('dormitorios'),
            bathrooms=estate_data.get('baños'),
